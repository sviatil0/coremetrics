...
A 4-person Notre Dame CSE 40232 software-engineering project (SP26 Team 04), three months, a PR-template + required-review workflow with per-developer branches. I was the lead and primary author: **89.3% of the source by line** (git-blame verified, recomputed on every push to `main`).
...
pie showData
    ...
    "Sviatoslav Oleksiienko (me)" : 11518
    "Alicia Melotik" : 906
...
| Author | Lines | Share |
| --- | ---: | ---: |
| **Sviatoslav Oleksiienko (me)** | 11518 | `██████████████████░░` 89.3% |
