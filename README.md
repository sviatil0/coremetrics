...
A 4-person Notre Dame CSE 40232 software-engineering project (SP26 Team 04), three months, a PR-template + required-review workflow with per-developer branches. I was the lead and primary author: **81.4% of the source by line** (git-blame verified, recomputed on every push to `main`).
...
pie showData
    ...
    "Sviatoslav Oleksiienko (me)" : 5885
    "Alicia Melotik" : 874
...
| Author | Lines | Share |
| --- | ---: | ---: |
| **Sviatoslav Oleksiienko (me)** | 5885 | `████████████████░░░░` 81.4% |
